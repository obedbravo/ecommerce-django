...
def register(request):
     ...
     if request.method == 'POST':
          ...
          if  form.is_valid():
               ...
               #una vez se crea un usuario con fuardar se crea en automatico un id de usuario y con ese vamos a vincular la foto del perfil con una imagen por default

               profile = UserProfile()
               profile.user_id=user.id
               profile.profile_picture = 'default/default-user.png' #esta dentro de la carpeta media
               profile.save()
    ...
    if request.method == 'POST':
         ...
         if new_password == confirm_password:
              ...
              if success:
                   ...
                   messages.error(request, 'La contraseña no coincide, vuelve a intentarlo!')
                   return redirect('change_password')
         else:
              messages.error(request, 'Las contraseñas no coinciden, verificalo y vuelve a intentar!')
              return redirect('change_password')
